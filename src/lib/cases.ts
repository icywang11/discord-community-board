...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    takeaway:
      "Bot 把版更预热做成闯关：解谜单场 3,948 条消息、925 反应；情报匣再用文字 + Emoji 谜题拿到 1,153 次交互、成功率 43.45%、曝光 6,150。发一篇预热帖只能看浏览，闯关能记下谁解出来了。",
  },
  {
    id: "d-milestone",
    community: "D",
    ...
    takeaway:
      "同一套截图回传连做会掉。二期加上里程碑奖池，同期才从 164 拉到 321，不是把原作业再发一遍。",
  },
  {
    id: "d-collect",
    community: "D",
    ...
    takeaway:
      "玩家本来就要换卡，频道只是把交易摊开。919 人里 93.7% 主动发了活动链接，反应数环比 +74.73%，比求投稿硬得多。",
  },
  {
    id: "d-unlucky",
    community: "D",
    ...
    takeaway:
      "发言就有机会拿身份组，高赞由 Bot 自动上墙。比惨自黑把跑图挫败感变成讨论，尾声一周人数还能 +40.2%。",
  },
  {
    id: "c-welfare",
    community: "C",
