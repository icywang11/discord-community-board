...
export const playbookTips: PlaybookTip[] = [
  ...
  },
  {
    ...
    mascot: "pudding",
    tone: "sun",
    body: "社区 D 的 H5 集换卡 919 人里，93.7% 是玩家自己把链接发出去的。换卡、集卡、名片打卡会自己把人拉进频道；「请发一篇攻略」常常冷场。能做成收集、站队、接力的，就别做成命题作文。",
  },
  {
    title: "预热做成 Bot 闯关",
    tag: "可统计",
    mascot: "pudding",
    tone: "sun",
    body: "社区 D 版本解谜单场 3,948 条消息；情报匣 1,153 次交互、成功 501、成功率 43.45%，消息 / 反应较上周 +147% / +302%。发预热帖只能看浏览；Bot 谜题能记下谁解出来了，版更节点优先复用。",
  },
  {
    title: "同一套玩法要分轨",
    tag: "分区",
  ...
  },
  {
    ...
    mascot: "berry",
    tone: "pink",
    body: "邮箱绑定、截图回传这类作业，第一次很亮，再做会明显变少。社区 D 二期加上里程碑奖池，同期回传才从 164 拉到 321（+95.7%）。同一条链路最多用一两个版本节点，后面改端内完成或换奖励，不要连做三轮还不改规则。",
  },
  {
    title: "浏览量要一起记",
    tag: "口径",
